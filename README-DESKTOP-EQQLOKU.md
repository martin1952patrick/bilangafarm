...
# Introduction
```
Bilanga System is a service and information providing platform that makes life 
...
```
For BILANGA system types of non-functional requirement 
...
```
In BILANGA system need a functional requirement 
1. A user can easily access recommended option following the flow chart.
2. BILANGA is very user-friendly application. User can see all the current 
option in the menu bar.
3. While using BILANGA user can get First help, quick replies and solutions.
4. User can see he/her profile, Number, Address, Location Including log out,
log in option.
6

6. BILANGA also give you the suitable season and weather details for 
cultivating crops.
7. BILANGA gives the best advice to the user by our expert doctors online.
